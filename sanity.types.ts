...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | Project | Stack | Post | Author | Category | Slug | BlockContent | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata | Code;
...
// Query: *[  _type == "project"  && defined(slug.current)]|order(publishedAt desc)[$startIndex...$endIndex]{  title,  "slug": slug.current,  publishedAt,  mainImage,  progress,  body,  shortDescription,  author->{    name,    image,  },    stacks[]->{    title,    "slug": slug.current,    image,  }}
