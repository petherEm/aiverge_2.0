    ...
    <div aria-hidden="true" className="relative h-full overflow-hidden">
      ...
      <div className="absolute inset-0 grid grid-cols-1 pt-8 [container-type:inline-size]">
        <Row>
          <Logo
            label="Next.js"
            src="/logo-timeline/nextjs-color.svg"
            className="[animation-delay:-26s] [animation-duration:30s] bg-white"
          />
          <Logo
            label="Medusa.js"
        ...
        <Row>
          ...
          <Logo
            label="Clerk"
            src="/logo-timeline/clerk-logo-dark-accent.svg"
